...
export const TICKET_LIST_MINE_REQUEST = 'TICKET_LIST_MINE_REQUEST';
export const TICKET_LIST_MINE_SUCCESS = 'TICKET_LIST_MINE_SUCCESS';
export const TICKET_LIST_MINE_FAIL = 'TICKET_LIST_MINE_FAIL';